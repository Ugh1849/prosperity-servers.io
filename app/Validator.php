...
class Validator {
    ...
    public function min($length){
        ...
        if(is_string($this->value)){
            ...
            if(strlen($this->value) < $length){
                $this->errors[] = 'The value of the "'.$this->name.'" field is too short.';
            }
    ...
    public function max($length){
        ...
        if(is_string($this->value)){
            ...
            if(strlen($this->value) > $length){
                $this->errors[] = 'The value of the "'.$this->name.'" field is too long';
            }
    ...
    public function equal($value){
        ...
        if($this->value != $value){
            $this->errors[] = 'The value of the  "'.$this->name.'" field does not match.';
        }
        return $this;
